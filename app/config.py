...
PURPOSE:
  Central place for all S.Y.L.P.H settings: API keys, paths, model names,
  and the SYLPH system prompt. Designed for single-user use: each person runs
...
WHAT THIS FILE DOES:
  ...
  - Holds the full system prompt that defines SYLPH's personality and formatting rules.

USAGE:
  Import what you need: `from config import GROQ_API_KEY, CHATS_DATA_DIR, SYLPH_SYSTEM_PROMPT`
...
# ============================================================================
# SYLPH PERSONALITY CONFIGURATION
# ============================================================================
...
_SYLPH_SYSTEM_PROMPT_BASE_FMT = _SYLPH_SYSTEM_PROMPT_BASE.format(assistant_name=ASSISTANT_NAME)
if SYLPH_USER_TITLE:
    SYLPH_SYSTEM_PROMPT = _SYLPH_SYSTEM_PROMPT_BASE_FMT + f"\n- When appropriate, you may address the user as: {SYLPH_USER_TITLE}"
else:
