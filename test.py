...
WHY IT EXISTS:
- Provides an easy way to test the SYLPH API without building a frontend
...
def print_header():
    print("\n" + "="*60)
    print("🤖 S.Y.L.P.H - General & Realtime Chat")
    print("="*60)
    print("\nModes:")
...
def send_message(message, mode):
    """
    Send a message to the appropriate SYLPH endpoint.
...
def get_chat_history():
    ...
    Note:
        ...
        - Messages are numbered and clearly labeled as "You" or "SYLPH" for clarity
    """
    if not SESSION_ID:
